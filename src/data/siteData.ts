export const siteData = {
  ...
  hero: {
    ...
    description:
      "I'm an MLOps & Platform Engineer who builds and operates cloud-based ML systems—from data ingestion and feature pipelines to automated training, deployment, and monitoring. I focus on making models reliable, scalable, and ready for real-world decision-making. Previously, I shipped production ML pipelines for personalization at scale and later focused on platform and database reliability in cloud environments.",
    tags: [
      "MLOps",
  ...
  expertise: [
    {
      ...
      description:
        "Building complete ML infrastructure: data ingestion, feature stores, automated training pipelines, model registries, and production deployment—systems that process hundreds of millions of rows daily. Scope includes platform design, deployment automation, observability, and operational readiness.",
      icon: "platform",
    },
    {
      title: "AI/ML Engineering",
      description:
        "From AutoML pipelines and time-series forecasting to LLM integrations and knowledge graphs. Building intelligent systems that solve real problems—with a focus on operational reliability, not just model accuracy. I prioritize production behavior over offline metrics.",
      icon: "ai",
    },
    {
      title: "CI/CD & Automation",
      description:
        'Designing GitOps workflows, optimizing build pipelines, and creating "golden paths" that let teams ship ML faster and more safely—without sacrificing reliability or auditability. Deliverables typically include CI templates, rollout strategies, and runbooks.',
      icon: "cicd",
    },
    {
      title: "Database Infrastructure",
      description:
        "Operating large-scale database systems: migrations, schema management, backup strategies, and disaster recovery. Treating databases as high-risk assets where reliability directly impacts business outcomes. My work emphasizes migration safety, rollback strategies, and operational clarity.",
      icon: "database",
    },
  ],
  philosophy: {
    ...
    paragraphs: [
      ...
      "This dual perspective shapes everything I build. I naturally think about second-order consequences: what happens when ownership changes, when priorities shift, when the model that worked yesterday starts drifting. In practice, this means designing for ownership, clear failure modes, and systems that can be debugged under pressure.",
    ],
    principles: [
      {
  ...
  about: {
    paragraphs: [
      "I'm a business-aware engineer who deliberately chose a deep technical path in MLOps and platform engineering. My experience spans production ML pipelines, platform and MLOps work, and database reliability tooling.",
    ...
    interests: ["Systems Thinking", "AI Ethics & Bias", "Design", "Photography"],
  },
  writing: [
    {
      date: "2024.12",
